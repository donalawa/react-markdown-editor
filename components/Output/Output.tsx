...
const Output = () => {
    ...
    const togglePreviewState = () => {
        setShowPreviewOnly(!currentPreviewState);
    }

    let cleanData =  DOMPurify.sanitize(marked.parse(currentFileContent)); 
