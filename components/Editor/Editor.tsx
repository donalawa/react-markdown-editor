...
const Editor = () => {
    ...
    const editorContent: any = useRef();
    ...
    useEffect(() => {
        ...
        editorContent.current.innerText = DOMPurify.sanitize(currentContent);
    ...
    const updateOutput = (e: any) => {
        setCurrentContent(e.currentTarget.innerText);
        updateStorage(e.currentTarget.innerText);
    }
    ...
    return (
        <div className={styles.editorContainer}>
            ...
            <div className={styles.editor_text} ref={editorContent} suppressContentEditableWarning={true} onKeyUp={updateOutput}  contentEditable={true} >
                {/* {newData} */}
            </div>
            </div>
        </div>
