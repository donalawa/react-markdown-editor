    ...
    return (
        <div className={styles.sidbarContainer}>
            ...
            <div className={styles.new_document}>
                <button className={styles.new_document_btn}>
            ...
            <div className={styles.files}>
                <div className={styles.file}>
                    ...
                    <div className={styles.file_info}>
                        <span className={styles.file_date}>15 May 2022</span>
                        <p className={styles.file_name}>welcome.md</p>
                    </div>
                </div>
                ...
                <div className={styles.file}>
                    ...
                    <div className={styles.file_info}>
                        <span className={styles.file_date}>15 May 2022</span>
                        <p className={styles.file_name}>untitled-document.md</p>
                    </div>
                </div>
            </div>
        </div>
